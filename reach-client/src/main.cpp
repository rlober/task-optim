...
int main (int argc, char * argv[])
{
    ...
    ctrlClient = std::make_shared<ReachClient>(modelIni.getModel(), loopPeriod);
    ...
    rf.setVerbose(true);
    rf.setDefaultConfigFile("reach-client.ini"); //default config file name.
    rf.setDefaultContext("reach-client"); //when no parameters are given to the module this is the default context
