...
int main (int argc, char * argv[])
{
    ...
    ctrlClient = std::make_shared<StandClient>(modelIni.getModel(), loopPeriod);
    ...
    rf.setVerbose(true);
    rf.setDefaultConfigFile("stand-client.ini"); //default config file name.
    rf.setDefaultContext("stand-client"); //when no parameters are given to the module this is the default context
