...
root_path = home_path + "/Optimization_Tests/parameter_tests-reaching/"
    ...
    for k in kernels:
        for a in acquisitionFunctions:
            for m in maximizers:
                ...
                print("========================================")
                first_test = OneComWaypointStaticTest(bo_test_path, right_hand_starting_waypoints, com_starting_waypoints, costs_to_use)
