...
root_path = os.path.expanduser("~") + "/Optimization_Tests/reaching_tests_target_set_01/"

costs_to_use=['tracking', 'goal', 'energy']

com_starting_waypoints = np.array([[0.015, -0.11, 0.51]])

rh_targets_file_path = "../right_hand_targets_set_01.txt"
...
for i,t in enumerate(rh_targets):
    print("\n\n========================================")
    print("Test number:", i+1, "of", rh_targets.shape[0], "tests.\nRight hand target:", t)
    print("========================================\n\n")
